...
export default function Contact() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
      ...
      />
      {/* Header Banner */}
      <div className="bg-gradient-to-br from-neutral-900 via-neutral-800 to-black text-neutral-900 dark:text-white p-6 md:p-10 rounded-3xl shadow-xl border border-neutral-800 relative overflow-hidden">
        <div className="absolute top-0 right-0 p-8 opacity-10 pointer-events-none">
          <Mail className="w-48 h-48 text-neutral-900 dark:text-white" />
        </div>
        ...
        <div className="relative z-10 max-w-2xl space-y-3">
          ...
          <p className="text-neutral-400 text-sm md:text-base leading-relaxed">
            Bạn muốn báo lỗi, đóng góp ý kiến hay gửi đề xuất tính năng mới cho <strong className="text-neutral-900 dark:text-white">Thế giới nhập vai_AD</strong>? Ban quản trị luôn lắng nghe phản hồi của bạn!
          </p>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-3xl p-8 md:p-12 text-center space-y-6 shadow-sm">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-3">
            <button
              ...
              className="px-6 py-3 rounded-2xl bg-neutral-900 dark:bg-neutral-100 text-neutral-900 dark:text-white dark:text-neutral-900 font-bold text-sm hover:opacity-90 transition-all shadow-md w-full sm:w-auto"
            >
              Gửi Yêu Cầu Khác
            </button>
          </div>
        ...
        <form onSubmit={handleSubmitTrigger} className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-3xl p-6 md:p-8 space-y-6 shadow-sm">
          ...
          <div className="p-5 rounded-3xl bg-amber-500/5 dark:bg-amber-500/10 border border-amber-500/20 space-y-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className={`flex-1 py-3 px-4 rounded-2xl font-bold text-xs md:text-sm border transition-all flex items-center justify-center gap-2 ${
                  needsResponse === 'NO'
                    ? 'bg-neutral-800 text-neutral-900 dark:text-white dark:bg-neutral-200 dark:text-neutral-900 border-neutral-800 dark:border-neutral-200 shadow-md'
              ...
              >
                <X className={`w-4 h-4 ${needsResponse === 'NO' ? 'text-neutral-900 dark:text-white dark:text-neutral-900' : 'text-neutral-400'}`} />
          ...
          <div className="pt-2">
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-4 rounded-2xl bg-gradient-to-r from-neutral-900 via-neutral-800 to-black hover:from-black hover:to-neutral-900 text-neutral-900 dark:text-white font-extrabold text-sm md:text-base shadow-xl border border-neutral-700 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {submitting ? (
